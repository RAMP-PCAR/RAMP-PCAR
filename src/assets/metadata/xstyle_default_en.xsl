  ...
  <xsl:template match="/">
    ...
    <div class="metadata-view">
      ...
      <xsl:if test="//gmd:abstract/gco:CharacterString/text() != ''">
        <h5 class="margin-bottom-none margin-top-small">Abstract</h5>
      ...
      <xsl:comment>
        <h5 class="margin-bottom-none margin-top-small">Scope</h5>
        <p class="shorten-candidate margin-top-none margin-bottom-medium">
          here be scope
        </p>
      </xsl:comment>
      ...
      <xsl:if test="//gml:TimePeriod//* != ''">
        <h5 class="margin-bottom-none margin-top-small">Time Period</h5>
        <p class="shorten-candidate margin-top-none margin-bottom-medium">
      ...
      <xsl:comment>
        <xsl:if test="//gmd:supplementalInformation/gco:CharacterString/text() != ''">
          <h5 class="margin-bottom-none margin-top-small">Supplemental Data</h5>
          <p class="shorten-candidate margin-top-none margin-bottom-medium">
      ...
      <xsl:if test="//gmd:pointOfContact//gmd:individualName/* != '' 
        ...
        <h5 class="margin-bottom-none margin-top-small">Contact Information</h5>
        <p class="shorten-candidate margin-top-none margin-bottom-medium">
