    ...
    function (
        ...
        return {
            init: function () {
                ...
                //$("body").on("click", "#addDatasetToggle", function (event) {
                //        console.log(event);
                //    }
                //);

                mainPopup = PopupManager.registerPopup(rootNode, "click",
                    function (d) {
                    ...
                    },
                    {
                        ...
                        containerSelector: "#searchMapSectionBody",
                        handleSelector: "#addDatasetToggle",
                        targetSelector: "#add-dataset-section-container",
                        activeClass: "button-pressed",
