        ...
        return {
            ...
            */
            isUndefined: function (obj) {
                console.warn(
                    'Think twice about using isDefined: consider checking explicitly or using a falsy test instead');
            ...
            */
            ...
            /**
            * Returns the width of the scrollbar in pixels. Since different browsers render scrollbars differently,
            * the width may vary.
            *
            ...
            */
            ...
            /**
            * Loops through all object properties and applies a given function to each. Resolves the
            * given deferred when done.
            *
            * @method executeOnDone
            * @static
            * @param {object} o Object to look through
            * @param {function} func A function to be executed with each object propety. Accepts two
            * parameters: property and deferred to be resolved when it's done.
            ...
            */
            ...
            // Query geometry
            /*
            * Create a new extent based on the current map size, a point (X/Y coordinates), and a pixel tolerance
            * value.
            * @method pointToExtent
            * @static
            * @param {Object} map The map control
            * @param {Object} point The location on screen (X/Y coordinates)
            * @param {Number} toleranceInPixel A value indicating how many screen pixels the extent should be
            * from the point
            ...
            */
            mergeRecursive: function () {
                ...
                // @param {Object} destination JSON object to have other objects merged into.  Parameter is modified
                // by the function.
            ...
            /**
            * Applies supplied xslt to supplied xml. IE always returns a String; others may return a documentFragment
            * or a jObject.
            *
            * @method transformXML
            * @static
            ...
            */
            transformXML: function (xmlurl, xslurl, callback, returnFragment, params) {
                ...
                if ('withCredentials' in new XMLHttpRequest() && 'ActiveXObject' in window) { // IE10 and above
                    ...
                    // for IE9 use loadXMLFileIE9 for the metadata XML -- uses XDomainRequest internally and allows
                    // cross domain requests
                    // use regular XHR for the XSLT as that should be located on the same server as RAMP
                    // XDR will break on same origin requests unless the same response headers are set allowing
                    // cross domain
                    // FIXME: delete all this as soon as IE9 is off the support list as it is fragile and unpleasant
                    // to maintain
            ...
            * @param {Array} ulNodes An array of <ul> tags containing a number of <li> tags to be made keyboard
            * sortable.
            * @param {Object} [settings] Additional settings
            * @param {Object} [settings.linkLists] Indicates if the supplied lists (if more than one) should be linked
            * - items could be moved from one to another; Update: this is wrong - items can't be moved from list to
            * list right now, but the keyboard focus can be moved between lists - need to fix.
            * @param {Object} [settings.onStart] A callback function to be called when the user initiates
            * sorting process
            * @param {Object} [settings.onUpdate] A callback function to be called when the user moves the item around
            * @param {Object} [settings.onStop] A callback function to be called when the user commits the item to its
            * new place ending the sorting process
            * @static
            */
            ...
            /**
             * Takes an array of timelines and their generator functions, clear and recreates timelines optionally
             * preserving the play position.
             ...
             * @static
             * @param {Array} tls An array of objects containing timeline objects and their respective generator
             * functions
             * @param {Boolean} keepPosition Indicates if the timeline should be set in the play position it was
             * in before the reset
             */
            ...
            * @param {String} [type] Type of the delimiter to detect. Possible values 'cell' or 'line'.
            * Defaults to 'cell'.
            ...
            */
             ...
             * @param  {String} [action] Action name: 'update' will update all the tooltips on target with their
             * respective title attributes;
