...
/**
* Bricks is a static collection of form controls rolled into prototypical objects with extra functions available.
* The main purpose is to use them in the choice tree for adding datasets but they can be reused anywhere where form
...
define([
    ...
    function (lang,
         ...
         * engine. The set of brick templates is suppled to the {{#crossLink 'TmplHelper'}}{{/crossLink}}   module.
         *
         * @method template
         * @private
        ...
        */
        Brick = Base.extend({
             ...
             * This is not used directly by the Brick itself, but instead by the external object manipulating a
             ...
             * @param  {Array|Object} [config.required] collection of rules specifying what external conditions must be
             * valid for the Brick to be enabled
             ...
             * @param  {String} [config.customContainerClass] any other optional CSS class to be added to the brick
             * container
            ...
            /**
             * Sets the state of the Brick. Checks if the state being set is a freezing state and freezes/unfreezes
             * the Brick.
             *
             * @method setState
            ...
            /**
             * Clears the Brick. This is an empty function. Bricks inheriting from this should override and provide
            ...
            /**
             * Checks if the brick is valid. This is an empty function. Bricks inheriting from this should override and
            ...
            /**
             * Sets Brick's data. This is an empty function. Bricks inheriting from this should override and provide
             * their specific implementations.
             *
             * @method setData
             * @return {Brick}           itself
            ...
            /**
             * Returns Brick's data. Bricks inheriting from this should override and provide their one implementation
             * and then call parent's getData method.
             *
             * @method getData
             * @param  {Object} [payload] data to be returned
             * @param  {Boolean} [wrap]    indicates of the payload should be wrapped with a Brick's id; useful when
             * collection information from several Bricks at once.
        ...
        /**
        * The MultiBrick prototype. Used as a container for multiple independent Bricks if they are required to be
        ...
        */
        MultiBrick = Brick.extend({
            ...
            */
             ...
             * @param  {String} [config.header] a Brick header
             * @param  {String} [config.instructions] a configuration object for the Brick
             * @param  {Array|Object} [config.required] collection of rules specifying what external conditions must
             * be valid for the Brick to be enabled
             * @param  {Boolean} [config.isEnabled] specifies if the brick is disabled from the start
             * @param  {Array} [config.freezeStates] a set of rules specifying states Brick should be frozen
             * @param  {String} [config.baseTemplate] a base template name to be used
             * @param  {String} [config.noticeTemplate] a notice template name to be used
            ...
            /**
             * Sets the state of the MultiBrick by setting states of the individual bricks inside the MultiBrick using
             * their specific setState methods.
             *
             * @method setState
             * @param {String} state a name of the state to set
            ...
            /**
             * Clears the MultiBrick by clearing of the individual bricks inside the MultiBrick using their specific
             * clear methods.
             *
             * @method clear
             * @return {MultiBrick}           itself
            ...
            /**
             * Sets MultiBrick's data by setting data to the individual bricks inside it. Uses their own specific
             * setData functions.
             *              *
             * @method setData
             * @param {Object} data
            ...
            /**
             * Returns MultiBrick's data by mixing together data of the individual bricks inside using their specific
             * getData methods and then passing it to the Brick's getData method for potential wrapping.
             *
             * @method getData
             * @for MultiBrick
             * @param  {Boolean} [wrap]    indicates of the payload should be wrapped with a Brick's id; useful when
        ...
        /**
        * ButtonBrick is just a Brick with a button inside it. The button can be styled and can be assigned an
        * onClick event.
        ...
        */
        ButtonBrick = Brick.extend({
            ...
            /**
             * Initializes the ButtonBrick by generating a specified template and setting defaults. Also sets a click
             * listener on the template button.
            ...
            /**
             * Returns ButtonBrick's data. Pretty useless function when you think of it. Just returns the data of the
             * Brick prototype which is empty.
             *
             * @method getData
             * @for ButtonBrick
             * @param  {Boolean} [wrap]    indicates of the payload should be wrapped with a Brick's id; useful when
        ...
        /**
        * CheckboxBrick is just a Brick with a checkbox inside it. The checkbox can be styled through its
        * checkbox-container.
        ...
        */
        CheckboxBrick = Brick.extend({
            ...
            */
            ...
            /**
             * Initializes the CheckboxBrick by generating a specified template and setting defaults. Also sets a
             * click listener on the template input checkbox.
             * CheckboxBrick is a simple button in the Brick container.
             *
             * If the `header` is provided, the Brick display it as a header element while hiding checkbox label and
             * displaying on/off labels beside the checkbox depending on the state.
             * If the `header` is no provided, Brick's label is displayed beside the checkbox.
             *
             * Provide header if the checkbox is a standalone feature or you have lots of space; omit header if the
             * checkbox is a part of a group of checkboxes or you want to conserve space.
             *
             * @method new
             * @param  {String} id     specified id of the Brick
             * @param  {Object} config a configuration object for the Brick
             ...
             * @method getData
             * @for CheckboxBrick
             * @param  {Boolean} [wrap]    indicates of the payload should be wrapped with a Brick's id; useful
             * when collection information from several Bricks at once.
        ...
        /**
        * CheckboxfsBrick is just a Brick with a checkbox inside it that is styles as a Formstone Checkbox.
        * The CheckboxFS can be further styled through its checkbox-container.
        * To instantiate, call {{#crossLink 'CheckboxfsBrick/new:method'}}{{/crossLink}} on the CheckboxfsBrick
        * prototype.
        *
        *
        * ####Imports RAMP Modules:
        ...
        */
        CheckboxfsBrick = CheckboxBrick.extend({
            ...
            /**
             * Initializes the CheckboxfsBrick by generating a specified template and setting defaults. Also sets a
             * change listener on the template input checkbox.
        ...
        /**
        * ToggleBrick is just a Brick with a checkbox inside it that is styles as a toggle. The toggle can be further
        * styled through its checkbox-container.
        ...
        */
        ToggleBrick = CheckboxBrick.extend({
            ...
            /**
             * Initializes the ToggleBrick by generating a specified template and setting defaults. Also sets a
             * change listener on the template input checkbox.
        ...
        /**
        * The OkCancelButtonBrick prototype. A MultiBrick with two ButtonBricks displayed side by side and
        * styled as OK and Cancel buttons.
        * To instantiate, call {{#crossLink 'OkCancelButtonBrick/new:method'}}{{/crossLink}} on the
        * OkCancelButtonBrick prototype.
        *
        *
        * ####Imports RAMP Modules:
        * {{#crossLink 'Util'}}{{/crossLink}}
        ...
        */
        OkCancelButtonBrick = MultiBrick.extend({
            /**
             * A dictionary of possible OkCancelButtonBrick events. Adds a OK_CLICK and CANCEL_CLICK events to the
             * default ButtonBrick events.
             *
             * @property event
            ...
            /**
             * Initializes the OkCancelButtonBrick by generating a specified template and setting defaults.
             * Also sets a click listener on the template button.
             * OkCancelButtonBrick is a brick with two preset buttons: OK and Cancel.
             * Button container classes are predefined as 'ok-button-brick-container'
             * and 'cancel-button-brick-container'
             *
             * @method new
             * @for OkCancelButtonBrick
             * @param  {String} id     specified id of the Brick
             ...
             * @param  {String} [config.header] a Brick header
             * @param  {String} [config.instructions] a configuration object for the Brick
             * @param  {Array|Object} [config.required] collection of rules specifying what external conditions
             * must be valid for the Brick to be enabled
             * @param  {Boolean} [config.isEnabled] specifies if the brick is disabled from the start
             * @param  {Array} [config.freezeStates] a set of rules specifying states Brick should be frozen
             * @param  {String} [config.baseTemplate] a base template name to be used
             * @param  {String} [config.noticeTemplate] a notice template name to be used
             * @param  {String} [config.containerClass] a CSS class of the specific brick container
             * @param  {String} [config.customContainerClass] any other optional CSS class to be added to the
             * brick container
             * @param  {String} [config.template] a name of the specific Brick template
             ...
             * @param  {String} [config.reverseOrder] reverses the default visual order of OK, Cancel button to
             * Cancel, OK.
             * @chainable
        ...
        */
        ChoiceBrick = Brick.extend({
            ...
            /**
             * A collection of choices that will be offered to the user. At least two choices are required for this
             * Brick to have any use at all.
             *
             * @property choices
             * @private
             * @type {Array}
            ...
            /**
             * Initializes the ChoiceBrick by generating a specified template and setting defaults. Also sets a click
             * listener on the template button.
             * The ChoiceBrick prototype. Provides a user the ability to choose a single item among several.
             *
             * @method new
            ...
            setChoice: function (choiceKey, userSelected) {
                ...
                if (choiceKey !== this.selectedChoice || (userSelected ? true : false) !== this.userSelected) {
                    ...
                    console.log('ChoiceBrick-' + this.id, ':', this.selectedChoice, '; userSelected:',
                        this.userSelected);
            ...
            /**
             * Checks if the brick is valid. The ChoiceBrick is considered valid if selectedChoice is
             * not an empty String.
             *
             * @method isValid
             * @return {Boolean}           true if valid; false if not
             ...
             * @method getData
             * @for ChoiceBrick
             * @param  {Boolean} [wrap]    indicates of the payload should be wrapped with a Brick's id;
             * useful when collection information from several Bricks at once.
        ...
        /**
        * The SimpleInputBrick prototype. Provides a control for a simple text input. Can be potentially
        * extended to serve more specific purposes.
        * To instantiate, call {{#crossLink 'SimpleInputBrick/new:method'}}{{/crossLink}} on the
        * SimpleInputBrick prototype.
        *
        *
        * ####Imports RAMP Modules:
        * {{#crossLink 'Util'}}{{/crossLink}}
        ...
        */
        DropDownBrick = Brick.extend({
            ...
            /**
             * Populates the drop down with provided set of options optionally replacing or appending them to the
             * existing options.
             *
             ...
             *  - {String} selectedOption string value of the option that should be preselected (either old or newly
             * added option)
             *  - {Boolean} userSelected boolean value indicating if the user is the source of the string value
             *
             * By default, after appending/replacing options, the first option will be selected unless specified
             * otherwise.
             *
             * @method setData
             * @param {Object} data a wrapper object for the data to be set.
        ...
        * To instantiate, call {{#crossLink 'ColorPickerBrick/new:method'}}{{/crossLink}} on the ColorPickerBrick
        * prototype.
        *
        *
        * ####Imports RAMP Modules:
        ...
        */
        ColorPickerBrick = SimpleInputBrick.extend({
            ...
            */
             ...
             * @param  {String} [config.label] an input field label. Invisible. Defaults to the Brick's header
             * @param  {String} [config.placeholder] a placeholder to be displayed inside the input field
             * @param  {String} [config.pickerPosition] specifies positions of the actual color picker (square wheel)
             * control
            ...
            isValid: function () {
                // TODO: if allowing color picker to start empty, need to check it's validity; otherwise,
                //it's always valid
            }*/
        ...
        /**
        * The FileInputBrick prototype extends SimpleInputBrick. Provides a control to either select a local file
        * or enter its URL.
        ...
        */
        FileInputBrick = SimpleInputBrick.extend({
            ...
            /**
             * A flag indicating if the user has selected the file or the file has been selected using some
             * magical means.
             *
             * @property userSelected
             * @private
             ...
             *
             * First calls setFileValue(null, false) to null the file object, then calls the prototype's setInputValue
            ...
            /**
             * Sets file value of the Brick. When setting file object, input value is set to ''. If value is null,
             * the form is reset.
             *
             * @method setFileValue
            ...
            /**
             * Checks if the FileInputBrick is valid. It's considered valid if the input value is not '' or a file
             * value is not null.
             *
             * @method isValid
             * @return {Boolean}           true if valid; false if not
            ...
            /**
             * Returns FileInputBrick's data. Either a file object or a file URL will be returned along with the
             * file name, not both.
             *
             * Returns an object:
        ...
        return {
            ...
            /**
             * The MultiBrick prototype. Used as a container for multiple independent Bricks if they are required
            ...
            /**
             * The SimpleInputBrick prototype. Provides a control for a simple text input. Can be potentially extended
