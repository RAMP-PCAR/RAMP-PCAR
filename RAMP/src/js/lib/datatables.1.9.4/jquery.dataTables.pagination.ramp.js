...
$.fn.dataTableExt.oPagination.ramp = {
    ...
    */
    "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
        ...
        var fnClickHandler = function (action) { // (e) {
            //console.log("before");
        ...
        //            '<span class="pagination-page-selector">Go to</span>' +
                    ...
                    '<ul class="button-group margin-right-small font-small pagination-arrow-controls">' +
			            '<li><button  class="' + oClasses.sPageButton + " " + oClasses.sPageFirst + ' button button-none" title="' + oLang.sFirst + '"><div><span class="wb-invisible">' + oLang.sFirst + '</span></div></button></li>' +
			            '<li><button  class="' + oClasses.sPageButton + " " + oClasses.sPagePrevious + ' button button-none" title="' + oLang.sPrevious + '"><div><span class="wb-invisible">' + oLang.sPrevious + '</span></div></button></li>' +
			            '<li><button  class="' + oClasses.sPageButton + " " + oClasses.sPageNext + ' button button-none" title="' + oLang.sNext + '"><div><span class="wb-invisible">' + oLang.sNext + '</span></div></button></li>' +
			            '<li><button  class="' + oClasses.sPageButton + " " + oClasses.sPageLast + ' button button-none" title="' + oLang.sLast + '"><div><span class="wb-invisible">' + oLang.sLast + '</span></div></button></li>' +
			        '</ul>' +
			    '</div>' +
            '</div>'
		);
    ...
    */
    "fnUpdate": function (oSettings, fnCallbackDraw) {
        ...
        var sList = "";
        var focusedPageButton;
        var iStartButton, iEndButton, i, iLen;
        var oClasses = oSettings.oClasses;
        var anButtons, anStatic, nPaginateList, nNode;
        var an = oSettings.aanFeatures.p;
        var fnBind = function (j, node) {
        ...
        for (i = 0, iLen = an.length; i < iLen; i++) {
            ...
            pageButton = $(nNode).find(".pagination-page-selector");
            ...
            $(anStatic).removeClass(oClasses.sPageButton + " " + oClasses.sPageButtonActive + " " + oClasses.sPageButtonStaticDisabled + " button-disabled");
            $([anStatic[0], anStatic[1]]).addClass(
				(iCurrentPage == 1) ?
					oClasses.sPageButtonStaticDisabled + " button-disabled" :
